...
export const githubMemoryCitationSchema = z.object({
  id: z.string().min(1),
  repo: z.string().min(1),
...
export type GitHubMemoryCitation = z.infer<typeof githubMemoryCitationSchema>;
...
export const compatibilityClassificationSchema = z.object({
  ...
  githubMemory: z.array(githubMemoryCitationSchema).max(8).optional(),
