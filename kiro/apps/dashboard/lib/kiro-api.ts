...
export async function getKiroSnapshot(): Promise<KiroSnapshot> {
  const [
    health,
    repo,
    worktrees,
    ...
    await Promise.allSettled([
      ...
      fetchJson<KiroSettings>("/api/settings")
    ]);
...
function disconnectedSnapshot(): KiroSnapshot {
  return {
    connected: false,
    coordinatorUrl,
    repo: null,
...
function demoSnapshot(connected: boolean): KiroSnapshot {
