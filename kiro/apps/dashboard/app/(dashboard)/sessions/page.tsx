    ...
    <>
      ...
      {!snapshot.connected && !snapshot.repo ? (
        <section className="surface disconnected-state">
          ...
          <div>
            <h2 className="page-title">No live Kiro data</h2>
            <p className="page-subtitle">
              Start `kiro` in a git repo to watch worktrees, agent checkpoints,
          ...
          <div>
            ...
            <p className="page-subtitle">
              {activeConflict?.summary ??
                "Kiro is watching for worktrees converging on shared contract surfaces."}
            </p>
          </div>
...
type Snapshot = Awaited<ReturnType<typeof getKiroSnapshot>>;
type TimelineItem = {
  title: string;
  detail: string;
  done: boolean;
  ...
  return [
    ...
    },
    {
      ...
      detail: activeConflict
        ? activeConflict.summary
        : "Kiro is watching for contract convergence.",
    ...
    },
    {
      ...
      detail: integrationActive && !allClean
        ...
        : readyForIntegration
        ? "Kiro coordination is complete; use a normal agent prompt for merging."
        : hasCoordinationActivity
